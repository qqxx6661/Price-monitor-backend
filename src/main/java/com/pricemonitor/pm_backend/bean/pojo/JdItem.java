...
public class JdItem implements Serializable {
    ...
    public JdItem(Integer id, Long itemId, Long categoryId, String name, String subtitle, String price, String plusPrice, String maxPrice, String minPrice, String discount, String lastPrice, String note, String sale, String label, String storeName, Boolean isZiying, Boolean isAlert, Date gmtCreate, Date gmtModified) {
        this.id = id;
        this.itemId = itemId;
